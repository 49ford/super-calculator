...
generic/index.html — a blank public template anyone can use with their own figures. Hosted at 49ford.github.io/super-calculator/generic. Nothing entered there is uploaded anywhere — it all stays in your browser.
What it models
